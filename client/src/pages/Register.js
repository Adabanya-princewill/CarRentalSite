       ...
       <div className="w-full max-w-sm mt-20 mx-auto overflow-hidden bg-white rounded-lg shadow-md dark:bg-gray-800">
        <div className="px-6 py-4">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="w-full mt-4">
              <input name="confirmPassword" onChange={handleChange} value={formData.confirmPassword} type='password' required className="block w-full px-4 py-2 mt-2 text-gray-700 placeholder-gray-500 bg-white border rounded-lg dark:bg-gray-800 dark:border-gray-600 dark:placeholder-gray-400 focus:border-orange-400 dark:focus:border-orange-300 focus:ring-opacity-40 focus:outline-none focus:ring focus:ring-orange-300" placeholder="Confirm Password" aria-label="Password" />
            </div>

            <div className="flex items-center justify-between mt-4">

              <button type='submit' className="px-6 mx-auto py-2 text-sm font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-orange-500 rounded-lg hover:bg-orange-400 focus:outline-none focus:ring focus:ring-orange-300 focus:ring-opacity-50">
                Register
              </button>
            </div>
          </form>
        ...
        <div className="flex items-center justify-center py-4 text-center bg-gray-50 dark:bg-gray-700">
          ...
          <NavLink to="/login" end>
            <span href="#" className="mx-2 text-sm font-bold text-orange-500 dark:text-orange-400">login</span>
          </NavLink>
        </div>
      </div>
    </>
